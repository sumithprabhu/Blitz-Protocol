      ...
      <div className="flex justify-between items-center w-full">
        ...
        <div className="relative">
          {isRootPage ? (
            <a
              href="/playground"
              className="text-lg inline-block text-white font-semibold px-6 py-2 rounded-lg bg-[#de7800] hover:bg-[#FF8B00] transition-all duration-300" // Neon border and hover effect
